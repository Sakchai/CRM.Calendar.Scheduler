...
namespace CRM.Model
{
    ...
    /// </summary>
    public partial class MsSqlFAADDataProvider : BaseDataProvider, IFAADDataProvider
    {
        #region Utils
        ...
        public virtual string BuildConnectionString(IFAADConnectionStringInfo nopConnectionString)
        {
